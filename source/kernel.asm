...
; Copyright (C) 2006 - 2022 ForgeOS Developers -- see doc/LICENSE.TXT
;
...
; ==================================================================
	...
	%DEFINE FORGEOS_VER '1.0.0'	; OS version number
	%DEFINE FORGEOS_API_VER 18	; API version for programs to check
...
; use a ForgeOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as ForgeOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to ForgeOS', 0
	os_version_msg		db 'Version ', FORGEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out ForgeOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute ForgeOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of ForgeOS, and', 0
