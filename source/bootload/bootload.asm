; ==================================================================
; The Forge Operating System bootloader
...
OEMLabel		db "FORGEBOOT"	; Disk label
...
VolumeLabel		db "FORGEOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; ForgeOS kernel filename
